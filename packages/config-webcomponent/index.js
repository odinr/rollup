...
exports.createConfig = (options) => {
    const { input, name, dir, ecma = 6, plugins = {}, pkg = require(process.cwd() + "/package.json") } = options;
    ...
    return {
        ...
        plugins: [
            ...
            typescript_1.default(Object.assign({ tsconfigDefaults }, typescript, { verbosity: !!verbose ? typescript && typescript.verbosity !== undefined ? typescript.verbosity : 2 : 0 })),
